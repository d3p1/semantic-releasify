...
> [!NOTE]
> If you want to generate a Docker image, you should define the following environment variables to authenticate with the defined registry: `DOCKER_REGISTRY_USER` and `DOCKER_REGISTRY_PASSWORD`.
> The default generated tags are: `[latest, {{major}}-latest, {{version}}]`.
> 
